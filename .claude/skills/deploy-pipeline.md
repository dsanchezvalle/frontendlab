...
description: Run the pre-deploy checklist for Next.js 15 (App Router) + React 19 + TypeScript 5 on Node 22. Use when the user says "ready to deploy", "deploy checklist", or before merging a release PR to main.
---
...
- [ ] `npm test --if-present` passes locally.
...
## Stack-specific notes (Next.js 15 (App Router) + React 19 + TypeScript 5 on Node 22)
